...
public class ConsultarReserva extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jButton_BuscarReserva_ = new javax.swing.JButton();
        ...
        jButton_BuscarReserva_.setText("Buscar Reserva");
        jButton_BuscarReserva_.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton_BuscarReserva_ActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGap(39, 39, 39)
                .addComponent(jButton_BuscarReserva_, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(81, 81, 81)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jButton_BuscarReserva_, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton_BuscarReserva_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_BuscarReserva_ActionPerformed
        
        String sqlcpfM = "SELECT * FROM Reservas WHERE datareserva = ?";
        this.BuscarTab(sqlcpfM);
        
       
    }//GEN-LAST:event_jButton_BuscarReserva_ActionPerformed
    ...
    public void LimparTab(){
        DefaultTableModel ModeloTab = (DefaultTableModel) jTable_Reserva.getModel();
    ...
    public void BuscarTab(String sql){
        ...
        DefaultTableModel ModeloTab = (DefaultTableModel) jTable_Reserva.getModel();
           ...
           // Conectar ao banco de dados e obter dados da tabela
            String SQL = JOptionPane.showInputDialog("Digite Data da Reserva:");
            try {
                //JOptionPane.showMessageDialog(null,sql);
                PreparedStatement ps = conn.getConexao().prepareStatement(sql);
                ps.setString(1, SQL);
    ...
    public void Atualizar(){
        int i = jTable_Reserva.getSelectedRow();
        // Obtendo o dados da primeira linha selecionada
        Reserva r = new Reserva();
        r.setIdreserva(jTable_Reserva.getModel().getValueAt(i,0).toString());
        r.setMesa((int) jTable_Reserva.getModel().getValueAt(i,1));
        r.setDatareserva(jTable_Reserva.getModel().getValueAt(i,2).toString());
        r.setPeriodo( jTable_Reserva.getModel().getValueAt(i,3).toString());
        r.setQtdpessoas((int) jTable_Reserva.getModel().getValueAt(i,4));
        r.setCliente((int) jTable_Reserva.getModel().getValueAt(i,5));
    ...
    public void Excluir(){
        ...
        int o = (int) jTable_Reserva.getValueAt(i, 0);
        Rdao.excluir(o);
    ...
    private javax.swing.JButton jButton_BuscarReserva_;
